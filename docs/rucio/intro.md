...
While spawning the session, you can choose to activate the extension; associated to that, a dediacted form allows you to choose which experiment's cluster to setup, as well as a dedicated Rucio Storage Element (RSE) to be used as local storage for the files.
