...
***DISCLAIMER***: If you are setting up environments or software stacks specific to your experiments (e.g. `setupATLAS`), you might already have a way to obtain a proxy certificate.
