...
Here, select the desired Rucio instance, and the corresponding Rucio Storage Element (RSE) to be used as local storage for the files.

![](../images/rucio_config_extra_options.png "Selecting Rucio instance and RSE in SWAN")
